...
public class DefaultSpiderImpl implements StockSpider {
    ...
    public  JSONArray getStockPrice(String[] stockCode) throws Exception {
        ...
        String query = String.format("https://hq.sinajs.cn/list=%s", queryCode);
        log.info(query);
        String content = null;
        try {
            content = Jsoup.connect(query).header("Referer","https://finance.sina.com.cn").timeout(timeout).ignoreContentType(true).get().text();
    ...
    public static void main(String[] args) throws Exception {
        DefaultSpiderImpl defaultSpider = new DefaultSpiderImpl();
        System.out.println(defaultSpider.getStockPrice(new String[]{"sz000777"}));
    }
